#!/bin/bash
# Double-click to start DealDesk. No Docker needed — just python3 (macOS ships it).
cd "$(dirname "$0")" || exit 1
...
echo "Starting DealDesk at http://localhost:$PORT — keep this window open. Close it to stop DealDesk."
